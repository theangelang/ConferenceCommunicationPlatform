...
/**
 * Class that gets the last users to send a message
 */

public class ViewLastUsersToMessage implements UserControl {
    ...
    public ViewLastUsersToMessage(UserQueueManager userQueueManager) {
    ...
    public void parseCommand(String command){
        List<String> statsList = userQueueManager.convertQueue("messageQueue");
        if(statsList.size() != 0) {
            menuPresenter.displayStatisticList(statsList, "viewLastUsersToMessage");
        }
        else{
